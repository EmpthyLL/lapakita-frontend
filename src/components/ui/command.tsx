  ...
  return (
    <div className="flex items-center gap-2">
      <CommandPrimitive.Input
        className={cn(
          "text-md flex-1 bg-transparent outline-none",
...
function CommandGroup({
  ...
  return (
    <CommandPrimitive.Group
      ...
      className={cn(
        "text-foreground **:[[cmdk-group-heading]]:text-muted-foreground **:[[cmdk-group-heading]]:text-md overflow-hidden p-1 **:[[cmdk-group-heading]]:px-2 **:[[cmdk-group-heading]]:py-1.5 **:[[cmdk-group-heading]]:font-medium",
        className,
      )}
      {...props}
    />
...
function CommandItem({
  ...
  return (
    <CommandPrimitive.Item
      ...
      className={cn(
        "text-md relative flex cursor-default items-center gap-2 rounded-sm px-2 py-1.5 outline-hidden select-none",
