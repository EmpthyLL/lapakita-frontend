...
export function AuthIllustrationPanel({
  ...
  return (
    <div className="relative hidden h-full flex-col justify-between overflow-hidden bg-gradient-brand p-10 text-white md:flex lg:p-14">
      ...
      {/* Startup Perspective Footer (No Overclaim) */}
...
// Re-export untuk kompatibilitas jika dipanggil dengan nama AuthIllustration
export const AuthIllustration = AuthIllustrationPanel;
