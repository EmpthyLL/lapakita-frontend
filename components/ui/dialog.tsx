...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ...
    ref={ref}
    className={cn(
      "bg-background/40 data-[state=open]:animate-in data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 backdrop-blur-sm",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(
      "text-md-lg leading-none font-semibold tracking-tight",
      className,
    )}
    {...props}
  />
